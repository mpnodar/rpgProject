...
ShadyPerson::ShadyPerson(std::string name) : TalkingNPC(5, name)
{
	dialogueTree[0] = new DialogueNode("Stop starin' and keep movin'.\n",
		...
		{ 1, 2, Ended });
	dialogueTree[1] = new DialogueNode("It aint non of your buisness.\n",
	...
	dialogueTree[2] = new DialogueNode("If you don't move we'll just make ya move!\n",
		"1. Fight\n2. Run Away\n",
		{ Attack, Ended });
	dialogueTree[3] = new DialogueNode("What makes you think well tell ya if we be doing a crime.\n",
		"1. I don't know I though that you simply would tell me.\n2. Enough talking its time to fight!\n3. Leave.\n",
		{ 4, Attack, Ended });
